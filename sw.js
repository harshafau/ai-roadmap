// Service Worker for AI Career Roadmap

const CACHE_NAME = 'ai-roadmap-cache-v1';
const urlsToCache = [
  '/ai-roadmap/',
  '/ai-roadmap/index.html',
  '/ai-roadmap/styles.css',
  ...
  'https://img.icons8.com/fluency/192/artificial-intelligence.png',
